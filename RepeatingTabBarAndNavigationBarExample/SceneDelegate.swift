...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func createTabBarController() -> UITabBarController {
        ...
        tabBarController.viewControllers = (0 ... 4)
            .map {
                ...
                contentViewController.tabBarItem.image = UIImage(systemName: "star")
                contentViewController.tabBarItem.selectedImage = UIImage(systemName: "star.fill")
    ...
    private func setTabBarItemBadgeAppearance(_ itemAppearance: UITabBarItemAppearance) {
        ...
        itemAppearance.normal.badgePositionAdjustment = UIOffset(horizontal: 10.0, vertical: -10.0)
    }
